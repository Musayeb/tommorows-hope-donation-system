...
<style>
  ...
  .profile-card-5 .card-img-block img{
    border-radius:2px;
    /* box-shadow:0 3px 10px rgba(0,0,0,0.63); */
    max-height:230px;
    object-fit: cover;
...
<section class="mt-4 mb-5">
  <div class="container">
    ...
    <div class="p-title">
      <h2 style="background-color: #358819;">Sponsorships</h2>
      <a href="https://tomorrowshope.tv/" class="upper-title">BACK TO HOMEPAGE</a>
    </div>
      ...
      <div class="col-log-4 col-md-4 mt-4">
        <div class="card profile-card-5 shadow">
          <div class="card-img-block">
            <a href="{{url('familylist')}}/{{Crypt::encrypt($item->id)}}">
          ...
          <div class="card-body pt-0">
            ...
            <a href="{{url('familylist')}}/{{Crypt::encrypt($item->id)}}" class="btn btn-success">Read More <span class="fa fa-angle-double-right ml-2"></span></a>
          </div>
        </div>
      </div>
      @endforeach
  ...
  <script>
    $(document).ready(function() {
      Command: toastr["error"]("Your payment is canceled.")
      toastr.options = {
        "closeButton": false,
        "debug": false,
        "newestOnTop": false,
  ...
  <script>
    $(document).ready(function() {
      Command: toastr["warning"]("Something is wrong.")
      toastr.options = {
        "closeButton": false,
        "debug": false,
        "newestOnTop": false,
