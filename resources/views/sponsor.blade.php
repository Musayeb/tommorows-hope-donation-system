...
@section('body')
    <div class="container mt-4 mb-5">
          ...
          <div class="p-title ">
            ...
            <a href="http://donate.tomorrowshope.tv/" class="upper-title">BACK TO DONATE</a>
          </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped text-center">
                ...
                <thead>
                  ...
                  <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                          ...
                          {{-- <td>{{$item->age}}</td> --}}
                          <td>{{$item->place}}</td>
                          <td>{{$item->sponsorship_level}}<span  class="ml-1">£</span></td>
                  ...
                  <caption class="text-right mt-2 mb-2 mr-3">Total :<span class="ml-2">{{$total}}<span class="ml-1">£</span></span></caption>
            </table>
          </div>
