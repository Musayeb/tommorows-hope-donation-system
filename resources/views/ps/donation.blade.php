...
<section class="mt-4 mb-5 font_pashto">
  <div class="container">
  
    <div class="p-title" style="text-align: right">
      <h2 style=" font-family: 'NassimPashto','Open Sans', sans-serif !important;">  {{ __('lang.sponsorships')}}</h2>
      <a href="https://tomorrowshope.tv/" class="upper-title" style="text-align: left;font-family: 'NassimPashto','Open Sans', sans-serif !important;" >  {{ __('lang.backhome')}}</a>
    </div>
      ...
      <div class="col-log-4 col-md-4 mt-4">
        <div class="card profile-card-5 shadow">
          <div class="card-img-block">
            <a href="{{url('ps/familylist')}}/{{Crypt::encrypt($item->id)}}">
          ...
          <div class="card-body pt-0">
            ...
            <p class="text-card">
              @php
              $disc=$item->disc;
              $disc=substr($disc,0,180);
              echo $disc . ' ...';
              @endphp
            </p>
            <a href="{{url('ps/familylist')}}/{{Crypt::encrypt($item->id)}}" class="btn btn-success"> {{ __('lang.readmore')}} <span class="fa fa-angle-double-left mr-2"></span></a>
          </div>
        </div>
      </div>
      @endforeach
