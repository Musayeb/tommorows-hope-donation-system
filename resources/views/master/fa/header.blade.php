                    ...
                    <ul class="navbar-nav custom_ul mr-auto toggole" >
                        ...
                        <ul class="toggole--ul" >
                            <li class="nav-item p-0 m-0 "  >
                                <a class="nav-link nav-custom   rtl-border " href="{{url( __('lang.homepage'))}}"> 
                                     {{ __('lang.backhome')}}
                                </a>
                            </li>
                            @auth
                       ...
                       @endauth
                        ...
                        <ul class="navbar-nav custom_ul ml-auto " id="main-nav-farsi" >
                         ...
                         <li class="nav-item p-0 m-0"  >
                            ...
                            <li class="nav-item p-0 m-0 farsi">
                                <a class="nav-link nav-custom" href="{{url( __('lang.homepage'))}}"> 
                                    {{ __('lang.backhome')}}
                                     <span class="fa fa-angle-double-right ml-2"></span>
                                </a>
                            </li>
