...
<html>
<head>
    <title>Checkout-Tomorrow's-Hope</title>
                ...
                <div class="panel panel-default credit-card-box shadow">
                    ...
                    <div class="panel-body">
                        ...
                        <div class='form-row row' style="margin-top:20px;">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-lg btn-block" type="submit"  style="background:#358819;color:white; ">Pay Now ({{$total}}<span style="font-weight:200px;">£</span>)</button>
                                </div>
                            </div>
